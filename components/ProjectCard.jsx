...
const ProjectCard = ({ project, displayRequirements, setDisplayRequirements, index }) => (
    <div className='relative bg-turbine-green rounded-lg cols-span-1'>
        <div key={project.id} className='font-mono text-sm rounded-lg h-60 p-5 bg-zinc-800 flex flex-col justify-between transition-all duration-200 hover:translate-x-1 hover:translate-y-1'>
            <div className='flex justify-between text-xl'>
                <div>
                    <h2 className='text-turbine-green font-extrabold'>
            ...
            <div className='mt-8 font-semibold flex justify-between'>
                <div>
                    ...
                    <a href={project.href.starter} className='ml-4 bg-turbine-green rounded-full px-4 py-1 transition-all duration-200 border-2 border-transparent hover:border-turbine-green hover:bg-transparent'>
                        starter
                    </a>
                </div>
